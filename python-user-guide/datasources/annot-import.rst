...
``--tables TABLE1 [--tables TABLE2 ...], -t TABLE1 [-t TABLE2 ...]``                       The list of tables which variables are to be annotated (defaults to all that are found in the input file)
``--taxonomies TAXONOMY1 [--taxonomies TAXONOMY2 ...], -tx TAXONOMY1 [-tx TAXONOMY2 ...]`` The list of taxonomy names of interest (default is any that is found in the input file)
========================================================================================== =====================================
