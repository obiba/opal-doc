...
``--resources RESOURCE1 [--resources RESOURCE2 ...], -r RESOURCE1 [-r RESOURCE2 ...]`` List of resource names on which the permission is to be get/set (default is all)
====================================================================================== =====================================
...
.. code-block:: bash
  ...
  opal perm-resource --opal https://opal-demo.obiba.org --user administrator --password password --type USER --project RSRC --subject demouser --permission view --add --resources CNSIM1 --resources CNSIM2
